...
class MultiTickerTrainer:
    ...
    def load_data(self, ticker):
        ...
        with open(f'{self.data_path}\\{ticker}_scaler_y.pkl', 'rb') as f:
...
if __name__ == "__main__":
    DATA_PATH = r'D:\Grad Project\processed_data_500'
    RESULTS_PATH = r'D:\Grad Project\results_500'
    
    # Auto-detect all processed tickers
    import os
    ...
    print(f'\n{"="*60}')
    print(f'[OK] ALL {len(TICKERS)} STOCKS COMPLETE!')
    print(f'{"="*60}\n')
